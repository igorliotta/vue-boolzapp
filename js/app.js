...
createApp({
  ...
  methods: {
    ...
    searchName() {
      const currentName = this.contacts[this.currentIndex].name;
      const searchedName = this.searchedName;

      for (
        this.currentIndex = 0;
        this.currentIndex < this.contacts[this.currentIndex].length;
        this.currentIndex++
      ) {
        if (currentName.includes(searchedName)) {
          this.contacts[this.currentIndex].visible === true;
        } else {
          this.contacts[this.currentIndex].visible === false;
        }

        // if (this.serchedName === this.contacts[this.currentIndex].name) {
        //     this.contacts[this.currentIndex].visible = true;
        // } else {
        //     this.contacts[this.currentIndex].visible = false;
        // }
      ...
      // this.contacts[this.currentIndex].name;
    },
  },
  mounted() {
